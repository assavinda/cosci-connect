...
const ProjectFilter: React.FC<ProjectFilterProps> = ({
    ...
    const statusOptions = [
        ...
        { value: 'assigned', label: 'มีผู้รับงานแล้ว' },
            ...
            <div className="p-4 flex flex-col md:flex-row gap-3">
                ...
                <div className="flex gap-2">
                    ...
                    >
                        ...
                        ตัวกรอง
                        {(selectedSkills.length > 0 || status !== 'open' || priceRange.min > 0 || priceRange.max < 10000) && (
                            <span className="bg-primary-blue-500 text-white text-xs w-5 h-5 rounded-full flex items-center justify-center">
                                {selectedSkills.length + (status !== 'open' ? 1 : 0) + (priceRange.min > 0 || priceRange.max < 10000 ? 1 : 0)}
                            </span>
                        )}
                    </button>
            ...
            {isFilterOpen && (
                <div className="p-4 bg-gray-50 border-t border-gray-200">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {/* Skills filter */}
                        <div>
                            <h3 className="text-gray-700 font-medium mb-2">ทักษะที่ต้องการ</h3>
                        ...
                        {/* Status filter */}
                        <div>
                            <h3 className="text-gray-700 font-medium mb-2">สถานะโปรเจกต์</h3>
                            <select
                        ...
                        {/* Price range filter */}
                        <div>
                            <h3 className="text-gray-700 font-medium mb-2">ช่วงงบประมาณ</h3>
                    ...
                    <div className="flex justify-between items-center mt-6">
                        ...
                        {/* Reset all filters */}
                        {(selectedSkills.length > 0 || status !== 'open' || priceRange.min > 0 || priceRange.max < 10000 || searchQuery) && (
                            <button 
